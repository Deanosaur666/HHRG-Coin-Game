...
The game is divided into 3 "campaigns," each with 8 turns and one propaganda round.

After the third propaganda round occurs, the game ends.

# Turn Procedure
- Event roll/propaganda
...
| 5    | Initiative player selects a valid space with to roll a shootout check.           |
| 6    | Initiative player selects a valid space and triggers a shootout there (no roll). |
